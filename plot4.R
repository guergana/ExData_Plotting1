plot4 <- function(){
  ...
  ##set screen for 2x2 plot matrix
  par(mfcol=c(2,2))
  ...
  ##third graph
  plot(only_dates$DateTime, only_dates$Voltage, type="n", ylab="Voltage", xlab="datetime")
  lines(only_dates$DateTime, only_dates$Voltage)
  
  ##fourth graph
  plot(only_dates$DateTime, only_dates$Global_reactive_power, type="n", ylab="Global_reactive_power", xlab="datetime")
  lines(only_dates$DateTime, only_dates$Global_reactive_power)
